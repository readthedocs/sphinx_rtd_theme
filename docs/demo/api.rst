...
.. We support Python 2.7, once that support is dropped, we can re-enable the full test of this extension.

This is a mock of the outputs generated by sphinx-automodapi. This mock is not fully accurate.
...
.. list-table::
   ...
   * - :func:`test_py_module.test.add_numbers`
     - Add two numbers together
   * - :func:`test_py_module.test.subtract_numbers`
